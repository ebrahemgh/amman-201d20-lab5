...
function sumAndMultiply(a, b, c) {
  ...
  let totalmult = multiply((multiply(a,b)[0]),c)[0];
...
function multiplyArray([d,e,f]) {
  //eslint-disable-line
  let first = multiply(d, e)[0];
  let seconed = multiply(first, f)[0];
  return [seconed,`The numbers ${d},${e},${f} have a product of ${seconed}.`]
}
...
function multiplyAnyArray(dynamicArray) {
  //eslint-disable-line
  // let counter = 0;
  // while (counter <= testDynamicArray.length) {
  //   let dynamicArray = multiply([counter], [++counter])[0];
    
  // }
  // return[dynamicArray,`The numbers 1,2,3,4,5 have a product of 120.`]
}
